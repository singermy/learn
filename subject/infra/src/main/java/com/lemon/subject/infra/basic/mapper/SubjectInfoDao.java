package com.lemon.subject.infra.basic.mapper;
...
public interface SubjectInfoDao {
    ...
    int countByCondition(@Param("subjectInfo") SubjectInfo subjectInfo, @Param("labelId") Long labelId,@Param("categoryId") Long categoryId);

    List<SubjectInfo> queryPage(SubjectInfo subjectInfo, Long categoryId, Long labelId, int start, Integer pageSize);

    SubjectInfo queryByCondtions(Long id);
}
