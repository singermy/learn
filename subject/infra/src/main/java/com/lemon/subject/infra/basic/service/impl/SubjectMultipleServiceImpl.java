package com.lemon.subject.infra.basic.service.impl;

import com.lemon.subject.infra.basic.entity.SubjectMultiple;
import com.lemon.subject.infra.basic.mapper.SubjectMultipleDao;
...
public class SubjectMultipleServiceImpl implements SubjectMultipleService {
    ...
    public List<SubjectMultiple> queryByCondition(SubjectMultiple subjectMultiple) {
        return  this.subjectMultipleDao.queryByConditions(subjectMultiple);
    }
}
