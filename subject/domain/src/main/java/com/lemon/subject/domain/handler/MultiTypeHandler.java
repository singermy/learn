...
import com.lemon.subject.domain.convert.MutilpleSubjectConverter;
...
import com.lemon.subject.infra.basic.service.SubjectMultipleService;
...
@Component
public class MultiTypeHandler implements SubjectTypeHandler{
    @Autowired
    ...
    public void add(SubjectInfoBO subjectInfoBO) {
        ...
        subjectInfoBO.getOptionList().forEach(option -> {
            SubjectMultiple subjectMultiple = MutilpleSubjectConverter.INSTANCE.convertBoToEntity(option);
    ...
    public SubjectOptionBO query(int subjectId) {
        ...
        List<SubjectAnswerBO> subjectAnswerBOList = MutilpleSubjectConverter.INSTANCE.convertEntityToBoList(result);
